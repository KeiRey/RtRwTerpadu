...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Create RW') }}</div>

                <div class="card-body">
                    <form method="POST" action="/admin/rw/store">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="no_rw" type="text" class="form-control @error('no_rw') is-invalid @enderror" name="no_rw" value="{{ old('no_rw') }}" required autocomplete="no_rw" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="nama_rw" class="col-md-4 col-form-label text-md-right">{{ __('Nama RW') }}</label>

                            <div class="col-md-6">
                                <input id="nama_rw" type="text" class="form-control @error('nama_rw') is-invalid @enderror" name="nama_rw" value="{{ old('nama_rw') }}" required autocomplete="nama_rw" autofocus>
